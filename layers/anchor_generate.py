...
from utils.bbox_transform import to_central_format, to_twoPoint_format

class FPNAnchors(nn.Module):
    def __init__(self, fpn_levels=None, level_strides=None, level_scales=None, anchor_scales=None, anchor_ratios=None):
    ...
    def forward(self, imgs):
        ...
        fpn_anchors = to_twoPoint_format(fpn_anchors, image_shape=image_shape)
        fpn_anchors = to_central_format(fpn_anchors)
